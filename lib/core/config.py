...
# Whether to shuffle data after loading or not
__C.DATA_LOADER.SHUFFLE_ROIDB = True
...
# Batch inference, working only for end to end models (external proposals not implemented)
...
# Dilation to use in the cls and bbox tower's filters
__C.RETINANET.HEAD_DILATION = 1
...
__C.DOWNLOAD_CACHE = b'output/download-cache'
